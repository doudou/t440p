 ...
 *
 * Disassembly of dsdt.dat, Wed Aug  5 09:29:03 2015
 *
 * Original Table Header:
 *     Signature        "DSDT"
 *     Length           0x000118EA (71914)
 *     Revision         0x01 **** 32-bit table (V1), no 64-bit math support
 *     Checksum         0x53
 *     OEM ID           "LENOVO"
 *     OEM Table ID     "TP-GL   "
 *     OEM Revision     0x00002300 (8960)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20120711 (538052369)
 */
DefinitionBlock ("dsdt.aml", "DSDT", 1, "LENOVO", "TP-GL   ", 0x00002300)
{
    /*
                ...
                Device (VID)
                {
                    ...
                    Method (GPON, 1, NotSerialized)
                    {
                        If (ISOP ())
                        {
                            ...
                            Else
                            {
                                If (((VSID != 0x220F17AA) && (VSID != 0x221D17AA)))
                                {
                                    \VHYB (0x04, 0x00)
                                }
                            }
